  ...
  return (
    <html lang="pt-BR">
      ...
      <body className={`${inter.className} bg-black text-white`}>
        {/* Wrapper em coluna pra “colar” o footer no fim sem espaço exagerado */}
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <header className="fixed top-0 inset-x-0 z-50 h-20 backdrop-blur border-b border-white/10 bg-black/30">
            <div className="mx-auto max-w-6xl h-full flex items-center justify-between px-6">
              ...
              <nav className="flex gap-4 text-white/80">
                ...
                <a href="mailto:id1366351@outlook.com">
          ...
          {/* Conteúdo com offset do header, ocupando o espaço restante */}
          <main className="pt-20 flex-1">
            {children}
          </main>

          {/* Footer mais baixo e com menos padding */}
          <footer className="mt-6 text-center text-xs sm:text-sm text-white/50 py-4 border-t border-white/10">
            <p>
